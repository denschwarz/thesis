...
\label{sec:cms}
	...
	\begin{figure}[tb]
		...
		\caption{Integrated luminosity recorded by CMS in comparison with the data delivered by LHC. \cite{CMSlumi}}
		\label{fig:CMS_lumi}
	\end{figure}	
\subsection{Tracker}
\label{sec:tracker}
