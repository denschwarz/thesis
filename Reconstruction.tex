...
\section{Muon Identification}
	...
	\end{itemize}
	If a candidate fulfils these criteria and holds the additional quality benchmarks $p_T > 55\;\text{GeV}$ and $|\eta| < 2.4$ it is stored and called muon in this analysis. Additionally, scale factors derived via a tag and probe method are applied to simulation to reach the same trigger efficiency as in data. 
