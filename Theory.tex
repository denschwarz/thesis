...
\section{Top Quark}
	...
	\begin{figure}
		...
		\caption{}
		\end{subfigure}
		\caption{Feynman diagrams \cite{feynman} showing the production of top quark pairs. Displayed are quark anti-quark annihilation (a), and gluon-gluon fusion in the s-channel (b), t-channel  (c) and u-channel (d).}
